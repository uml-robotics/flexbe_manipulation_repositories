...
from mtc_ros2.action import MTCRetreatAndPlace


class MTCRetreatAndPlaceActionState(EventState):
    """
    MTC - add detail.
    ...
    def execute(self, userdata):
        ...
        try:
            r = self._ac.get_result(self._action_name)  # type: MTCRetreatAndPlace.Result
    ...
    def on_enter(self, userdata):
        ...
        try:
            self._ac = ProxyActionClient({self._action_name: MTCRetreatAndPlace})
        except Exception as e:
